...
KINDLE_SENDER_EMAIL = os.getenv("KINDLE_SENDER_EMAIL", "").strip()
KINDLE_SMTP_HOST = os.getenv("KINDLE_SMTP_HOST", "").strip()
KINDLE_SMTP_PORT = _env_int("KINDLE_SMTP_PORT", 587)
KINDLE_SMTP_USERNAME = os.getenv("KINDLE_SMTP_USERNAME", "").strip()
KINDLE_SMTP_PASSWORD = os.getenv("KINDLE_SMTP_PASSWORD", "").strip()
KINDLE_SMTP_USE_TLS = _env_bool("KINDLE_SMTP_USE_TLS", True)
KINDLE_SMTP_USE_SSL = _env_bool("KINDLE_SMTP_USE_SSL", False)
KINDLE_MAX_ATTACHMENT_MB = _env_int("KINDLE_MAX_ATTACHMENT_MB", 45)
